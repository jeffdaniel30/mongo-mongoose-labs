...
Find the [INTERMEDIATE_MONGO.md lecture notes](https://git.generalassemb.ly/flex-323/intro-to-mongo-mongoose/blob/master/advanced_mongo/2.intermediate_mongo.md). Follow through each of the explanations. Follow the commands and perform appropriate finds after each update call to see the results
